import { ShoppingBag, MapPin, Phone, Clock, Heart } from 'lucide-react';
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading text-lg font-bold text-white">
                Apni <span className="text-primary-400">Local Shop</span>
              </span>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-gray-400">
              Your trusted neighbourhood shop for groceries, household items, and daily
              essentials. Quality products at reasonable prices.
            </p>
            <button
              onClick={() => openWhatsApp(DEFAULT_WHATSAPP_MESSAGE)}
              className="mt-5 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary-500/20 transition-all hover:brightness-110"
            >
          ...
          {/* Contact */}
          <div>
            <h3 className="font-heading text-base font-bold text-white">Contact Details</h3>
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center gap-2.5 text-sm text-gray-400">
                ...
                <a href={`tel:${SHOP.phone.replace(/\s/g, '')}`} className="hover:text-primary-400">
                  {SHOP.phone}
                </a>
              </li>
              <li className="flex items-start gap-2.5 text-sm text-gray-400">
            ...
            <div className="mt-4 flex gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-800 text-gray-400 transition-all hover:bg-primary-500 hover:text-white"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-800 pt-6 sm:flex-row">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Apni Local Shop. All rights reserved.
          </p>
          <p className="flex items-center gap-1.5 text-sm text-gray-500">
            Made with <Heart className="h-4 w-4 fill-rose-500 text-rose-500" /> for our local
            community
          </p>
        </div>
      </div>
